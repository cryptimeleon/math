 ...
 */
public class DebugGroupImplG1Total extends DebugGroupImplTotal {
    ...
    public DebugGroupImplG1Total(String name, BigInteger n) {
        super(name, n);
    }

    public DebugGroupImplG1Total(Representation repr) {
        super(repr);
    }
