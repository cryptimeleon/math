...
import org.cryptimeleon.math.serialization.annotations.ReprUtilTest;
import org.cryptimeleon.math.serialization.standalone.params.*;
import org.cryptimeleon.math.serialization.standalone.params.*;
...
public class StandaloneTest {
    ...
    public static Collection<StandaloneTestParams> getStandaloneClasses() {
        Reflections reflection = new Reflections("org.cryptimeleon.math");
        ...
        toReturn.addAll(Secp256k1Params.get());
